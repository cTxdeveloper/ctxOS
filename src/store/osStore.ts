...
import { useFileSystem } from '@/composables/useFileSystem' // Using alias

// --- Application Component Imports ---
// THE FIX: Using the '@/' alias which points to the 'src/' directory.
...
import PasswordCracker from '@/components/applications/PasswordCracker.vue'
import ThemeStudio from '@/components/applications/ThemeStudio.vue'
...
export const useOSStore = defineStore('os', {
  state: () => ({
    apps: [
      ...
      { id: 'theme_studio', title: 'Theme Studio', icon: 'Palette', component: markRaw(ThemeStudio) },
